              ...
              >
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    name="customerName"
                  />
                  {formiks.touched.customerName &&
                  formiks.errors.customerName ? (
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    name="customerMobile"
                  />
                  {formiks.touched.customerMobile &&
                  formiks.errors.customerMobile ? (
                    <div className="error">
                      {" "}
                      {formiks.errors.customerMobile}
                    </div>
              ...
              >
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    className="form-control shadow-none"
                    value={
                      Object.keys(quantitys).length && quantitys
                        ? quantitys.availableInStock !== 0
                          ? quantitys.availableInStock
                          : "Out Of Stock"
                        : "Select a Product"
                    }
                    readOnly
                ...
                <button
                  ...
                  disabled={quantitys.availableInStock === 0}
                >
                  {" "}
                  <span className="cz">
          ...
          <div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                className="form-control shadow-none"
                id="exampleInputEmail1"
                value={payment ? `Rs : ${payment.Gst}` : null}
                readOnly
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                className="form-control shadow-none"
                id="exampleInputEmail1"
                value={payment ? `Rs : ${payment.Discount}` : null}
                readOnly
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                className="form-control shadow-none"
                id="exampleInputEmail1"
                value={payment ? `Rs : ${payment.Total}` : null}
                readOnly
              />
            </div>
          </div>
        ...
        <div className="d-flex justify-content-center align-items-center mt-5 mb-5">
          {button ? (
            ...
            <button
              type="button"
              onClick={() =>
                placeOrder(customerDetail, order, payment, paymentType)
              }
