                ...
                return (
                  <tr key={index}>
                      ...
                      {item.order.map((item, index) => {
                        return (
                          <>
                            <span>
                              {" "}
                              <span className="error">Product Name</span> :{" "}
                              {item.product}
                            </span>
                            <br />
                            <span>
                              {" "}
                              <span className="error">Quantity</span> :{" "}
                              {item.quantity}{" "}
                            </span>
                            <br />
                            <span>
                              {" "}
                              <span className="error">Rate</span> : Rs : -{" "}
                              {item.rate}
                            </span>
                            <br />
                            <span>
                              {" "}
                              <span className="error">Total</span> : Rs : -{" "}
                              {item.total}
                            </span>
                            <br />
                            <hr className=" p-1" />
                    ...
                    <td>
                      <span>
                        {" "}
                        <span className="error">Product Amount</span> : Rs : -{" "}
                        {item.payment.Amount}
                      </span>
                      <br />
                      <span>
                        {" "}
                        <span className="error">Discount</span> : Rs : -{" "}
                        {item.payment.Discount}
                      </span>
                      <br />
                      <span>
                        {" "}
                        <span className="error">GST</span> : Rs : -{" "}
                        {item.payment.Gst}
                      </span>
                      <br />
                      <hr />
