          ...
          <div className="col-sm-12 col-md-6">
            ...
            <div className="form-group">
              ...
              <input
                ...
                className="form-control shadow-none"
                id="exampleInputEmail1"
                placeholder="Enter Your Update Profile Image"
              ...
              {formik.touched.profileUrl && formik.errors.profileUrl ? (
                <div className="error"> {formik.errors.profileUrl}</div>
              ) : null}
            </div>
            <button type="submit" className="btn btn-success mt-4 mb-3">
              {" "}
              <span className="cz">
        ...
        <div className="">
          <div className="form-group">
            ...
            {formik1.touched.oldPassword && formik1.errors.oldPassword ? (
              <div className="error"> {formik1.errors.oldPassword}</div>
            ) : null}
          </div>
          <div className="form-group">
            ...
            {formik1.touched.newPassword && formik1.errors.newPassword ? (
              <div className="error"> {formik1.errors.newPassword}</div>
            ) : null}
          </div>
          <div className="form-group">
            ...
            <input
              ...
              readOnly
            />
            {formik1.touched.conformPassword &&
            formik1.errors.conformPassword ? (
              <div className="error"> {formik1.errors.conformPassword}</div>
            ) : null}
          </div>
