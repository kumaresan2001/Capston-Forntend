...
export const AdminProvider = ({ children }) => {
  ...
  const editBrand = async (values, id) => {
    try {
      let value = await axios.put(
        `${env.api}/inventory/edit-brand/${id}`,
        values
      );
      getBrand();
      const { data } = value;
  ...
  const editCategory = async (values, id) => {
    try {
      let value = await axios.put(
        `${env.api}/inventory/edit-category/${id}`,
        values
      );
      getCategory();
      const { data } = value;
  ...
  const deleteCategory = async (id) => {
    try {
      let value = await axios.delete(
        `${env.api}/inventory/delete-category/${id}`
      );
      getCategory();
      const { data } = value;
      const { message, statusCode } = data;
  ...
  const editProduct = async (values, id) => {
    try {
      let value = await axios.put(
        `${env.api}/inventory/edit-product/${id}`,
        values
      );
      const { data } = value;
      const { message, statusCode } = data;
  ...
  const deleteProduct = async (id) => {
    try {
      let value = await axios.delete(
        `${env.api}/inventory/delete-product/${id}`
      );
      const { data } = value;
      const { message, statusCode } = data;
      if (statusCode === 200) {
    ...
    try {
      ...
      if (!query) {
        ...
        value = await axios.get(
          `${env.api}/inventory/dashboard-products?q=${query}`
        );
      }
      const { data } = value;
  ...
  const getDashboardBarChart = async (query) => {
    try {
      ...
      let value = await axios.get(
        `${env.api}/inventory/dashboard-barChart/${query}`
      );
      // } else {
